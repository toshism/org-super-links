...
(defvar sl-search-function 'sl-search-function-default
...
(defun sl-search-function-default ()
  "Default `sl-search-function'."
  (let ((target (org-refile-get-location "Super Link target")))
